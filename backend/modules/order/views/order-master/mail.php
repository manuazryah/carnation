                                                        ...
                                                        <div class="header" style="padding-bottom: 0px;">
                                                                ...
                                                                <div class="navigation-bar"style="text-align: center;">
                                                                        <ul style="text-align: center;width: 100%;padding: 5px 0px;margin: 0;list-style-type: none;background-color: #93c622;">
                                                                                ...
                                                                                <li style="display: inline;"><a target="_blank" style="width: 6em;text-decoration: none;color: white;padding: 0.2em 0.6em;border-right: 1px solid white;" href="http://<?= Yii::$app->request->serverName ?>/carnation/product/index?type=0">OUR PRODUCTS</a></li>
                                                                                ...
                                                                                <tr>
                                                                                        <td style="padding-bottom: 1em;">
                                                                                                 <p><strong>Dear <?= $user_detail->first_name . ' ' . $user_detail->last_name ?>, </strong><br><br>
                                                                                                                        <?php if ($status != 5) { ?>
                                                                                                                                Your order has been <?= $subject ?> successfully. The expected delivery date is  <?= date('d-m-Y', strtotime($order_master->expected_delivery_date)) ?> .<br> Here is the summary of your purchase.
                                                                                                                        <?php } else { ?>
                                                                                                                                Your order has been canceled.Here is the summary of your canceled order.
...
//                                                                                                                                                                $total_amount += $order_product->rate;
                                                                                                                                                        ...
                                                                                                                                                        <tr>
                                                                                                                                                                ...
                                                                                                                                                                <td style="padding-bottom: 1em;font-size: 14px;padding-top: 1em;">AED <?= sprintf('%0.2f', $order_master->total_amount) ?></td>
                                                                                                                                                        </tr>
                                                                                                                                                        <?php
                                                                                                                                                        ...
                                                                                                                                                        <tr>
                                                                                                                                                                ...
                                                                                                                                                                <td style="padding-bottom: 1em;font-size: 14px;">AED <?= sprintf('%0.2f', $order_master->shipping_charge) ?></td>
                                                                                                                                                        </tr> 
                                                                                                                                                    <?php if($order_master->gift_wrap == '1'){?>
                                                                                                                                                        <tr>
                                                                                                                                                                <td colspan="2" style="padding-bottom: 1em;font-size: 14px;"><b>Gift Wrap charge</b></td>
                                                                                                                                                        ...
                                                                                                                                                        In the meantime, you can find some useful information by clicking on the below links: <br>
                                                                                                                                                                ...
                                                                                                                                                                <hr style="border: 1px solid #93c622;">
                                                                                                                                                                        <div class="main-content" style="text-align:center;">
                                                                                                                                                                                ...
                                                                                                                                                                                <p style="margin:0px;font-size: 13px;">For any queries : Tel :+971 (0)4 3217 112 </p>
