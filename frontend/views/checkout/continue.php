...
<section class="in-cart-page">
                        ...
                        <tbody>
                            ...
                            foreach ($cart_items as $cart_item) {
                                ...
                                <tr class="cart_item tr_<?= yii::$app->EncryptDecrypt->Encrypt('encrypt', $cart_item->id); ?>">
                                    <td class="text-center"><a href="<?= Yii::$app->homeUrl . 'product-detail/' . $product_details->canonical_name ?>"><?= $image ?></a></td>
                                    <td class="text-left"><a href="<?= Yii::$app->homeUrl . 'product-detail/' . $product_details->canonical_name ?>"><?= ucwords($prod_details->product_name) ?></a> <br>
    <!--                                            <small>Delivery Date: 2011-04-22</small> <br>
                                        <small>Reward Points: 300</small></td>-->
                                    <!--<td class="text-left">Product 21</td>-->
                                    <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">
                                            <input  type="number" min="1" max="<?= $prod_details->stock ?>" step="1" value="<?= $cart_item->quantity ?>" id="quantity_<?= yii::$app->EncryptDecrypt->Encrypt('encrypt', $cart_item->id); ?>" class="ordqnty form-control">
    <!--                                                <input type="text" name="quantity[139]" value="1" size="1" class="form-control">
                                    ...
                                    <td class="product-remove">
                                        <a class="btn btn-danger remove_order" title="Remove this item" data-product_id="<?= yii::$app->EncryptDecrypt->Encrypt('encrypt', $cart_item->id); ?>">×</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
...
<!--                                <tr>
                ...
                <div class="buttons clearfix">
                    ...
                    <div class="pull-right">
                        ...
                        <?php } else { ?>
                            <a href="<?= Yii::$app->homeUrl . 'checkout/proceed' ?>" class="btn btn-primary">Checkout</a>
                        <?php } ?>
